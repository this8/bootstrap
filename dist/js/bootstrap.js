...
(function (global, factory) {
  ...
  class Carousel extends BaseComponent {
    ...
    static carouselInterface(element, config) {
      ...
      let _config = _objectSpread2(_objectSpread2({}, Default$8), Manipulator.getDataAttributes(element));
    ...
    static dataApiClickHandler(event) {
      ...
      const config = _objectSpread2(_objectSpread2({}, Manipulator.getDataAttributes(target)), Manipulator.getDataAttributes(this));
  ...
  class Collapse extends BaseComponent {
    ...
    _getConfig(config) {
      config = _objectSpread2(_objectSpread2({}, Default$7), config);
    ...
    static collapseInterface(element, config) {
      ...
      const _config = _objectSpread2(_objectSpread2(_objectSpread2({}, Default$7), Manipulator.getDataAttributes(element)), typeof config === 'object' && config ? config : {});
  ...
  class Modal extends BaseComponent {
    ...
    static jQueryInterface(config, relatedTarget) {
      return this.each(function () {
        ...
        const _config = _objectSpread2(_objectSpread2(_objectSpread2({}, Default$5), Manipulator.getDataAttributes(this)), typeof config === 'object' && config ? config : {});
  ...
  class Offcanvas extends BaseComponent {
    ...
    _getConfig(config) {
      config = _objectSpread2(_objectSpread2(_objectSpread2({}, Default$4), Manipulator.getDataAttributes(this._element)), typeof config === 'object' ? config : {});
  ...
  const Default$2 = _objectSpread2(_objectSpread2({}, Tooltip.Default), {}, {
    placement: 'right',
    offset: [0, 8],
    trigger: 'click',
    content: '',
  ...
  const DefaultType$2 = _objectSpread2(_objectSpread2({}, Tooltip.DefaultType), {}, {
  ...
  class ScrollSpy extends BaseComponent {
    ...
    _getConfig(config) {
      config = _objectSpread2(_objectSpread2({}, Default$1), typeof config === 'object' && config ? config : {});
