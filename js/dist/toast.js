...
(function (global, factory) {
  ...
  class Toast extends BaseComponent__default['default'] {
    ...
    _getConfig(config) {
      config = _objectSpread2(_objectSpread2(_objectSpread2({}, Default), Manipulator__default['default'].getDataAttributes(this._element)), typeof config === 'object' && config ? config : {});
