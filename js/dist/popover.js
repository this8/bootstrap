...
(function (global, factory) {
  ...
  const Default = _objectSpread2(_objectSpread2({}, Tooltip__default['default'].Default), {}, {
    placement: 'right',
    offset: [0, 8],
    trigger: 'click',
    content: '',
  ...
  const DefaultType = _objectSpread2(_objectSpread2({}, Tooltip__default['default'].DefaultType), {}, {
