...
(function (global, factory) {
  ...
  class Collapse extends BaseComponent__default['default'] {
    ...
    static collapseInterface(element, config) {
      ...
      const _config = _objectSpread2(_objectSpread2(_objectSpread2({}, Default), Manipulator__default['default'].getDataAttributes(element)), typeof config === 'object' && config ? config : {});
